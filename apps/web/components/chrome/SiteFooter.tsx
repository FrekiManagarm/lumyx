...
export function SiteFooter() {
  return (
    <footer style={{ borderTop: '1px solid var(--border-subtle)' }}>
      <div className={`${s.grid} mx-auto max-w-[1280px] px-5 pt-12 pb-8 md:px-6 lg:px-10`}>
      ...
      <div className="mx-auto flex max-w-[1280px] flex-wrap items-center gap-4 px-5 pb-8 md:px-6 lg:px-10">
