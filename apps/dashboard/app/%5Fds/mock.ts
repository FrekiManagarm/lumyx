...
export const PEERS: Peer[] = [
  { peer_id: 'a3f91c02', room: 'test-room', score: 96, rtt: 38, jitter: 11, loss: 0.2, nack: 0.9, freeze: 0, codec: 'vp8', tracks: ['audio', 'video'], status: 'live', region: 'eu-west-3' },
  { peer_id: '0b8e2f61', room: 'test-room', score: 88, rtt: 44, jitter: 14, loss: 0.04, nack: 1.1, freeze: 0, codec: 'h264', tracks: ['audio', 'video'], status: 'live', region: 'eu-west-3' },
  { peer_id: '5e7b21f4', room: 'test-room', score: 74, rtt: 96, jitter: 22, loss: 0.81, nack: 2.4, freeze: 0.2, codec: 'vp8', tracks: ['audio'], status: 'live', region: 'eu-west-3' },
  { peer_id: 'd41f9ab7', room: 'test-room', score: 41, rtt: 212, jitter: 38, loss: 3.41, nack: 6.2, freeze: 1.4, codec: 'vp8', tracks: ['audio', 'video'], status: 'degraded', region: 'us-east-1' },
  { peer_id: '9c0d34aa', room: 'test-room', score: 92, rtt: 41, jitter: 9, loss: 0.11, nack: 0.7, freeze: 0, codec: 'vp9', tracks: ['audio', 'video'], status: 'live', region: 'eu-west-3' },
  { peer_id: '2f81be07', room: 'test-room', score: 62, rtt: 128, jitter: 31, loss: 1.62, nack: 4.1, freeze: 0.6, codec: 'vp8', tracks: ['audio', 'video'], status: 'degraded', region: 'eu-west-3' },
];
